package com.amaryllis.weathercheck.view
...
import com.amaryllis.weathercheck.R
import com.amaryllis.weathercheck.viewmodel.MainViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var cName = GET.getString("cityName", "Semarang")?.toLowerCase()
